...
<div class="hdq_highlight">
						<p>
							<strong>NEW:</strong> Patreon contributors of $10+/m will receive access to ALL first-party (developed by Harmonic Design) addons for FREE. Please visit the <a href="https://www.patreon.com/harmonic_design" target="_blank">patreon page</a> to help continued development. Every little bit helps, and I am fuelled by coffee ☕. Addons will automatically appear here once available, so check back often!</p>
					</div>					
